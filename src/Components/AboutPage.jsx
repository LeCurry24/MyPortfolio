        ...
        <div className={styles.aboutMe}>
          ...
          <div>
            <p className={styles.aboutMeParagragh}>
              ...
              React, Python, SQL, and FastAPI. This strong foundation enabled me
              to create several early projects, including a terminal-based
              luxury car RPG and an interactive movie database application.
            </p>
            <p className={styles.aboutMeParagragh}>
